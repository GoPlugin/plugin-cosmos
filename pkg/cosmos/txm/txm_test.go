...
// TestTxm_Integration is disabled in order to be moved to plugin-cosmos before DB testing is available
...
//	cfg, db := heavyweight.FullTestDBNoFixturesV2(t, "cosmos_txm", func(c *plugin.Config, s *plugin.Secrets) {
...
//	// the plugin-cosmos repo instead of copying it to cores testdata
