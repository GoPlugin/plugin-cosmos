...
require (
	...
	github.com/goplugin/plugin-libocr v0.0.0-20231130143053-c5102a9c0fb7
...
replace (
	...
	//github.com/hashicorp/go-plugin => github.com/goplugin/go-plugin v0.0.0-20231003134350-e49dad63b306
