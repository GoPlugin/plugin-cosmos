...
container_name="plugin-cosmos.core"
container_version="2.3.0"

# https://github.com/goplugin/blob/600365a7a27508d699dbd4b994fafba7dc288659/integration-tests/client/plugin_k8s.go#L82-L83
