...
pub fn execute_accept_proposal(
    ...
    // https://github.com/goplugin/plugin-cosmos/issues/27
    // Clear out oracles
...
pub fn execute_propose_config(
    ...
    // See corresponding comment https://github.com/goplugin/plugin-cosmos/blob/5c229358eea2633922de615be509eb47c5bcb998/pkg/terra/config_digester.go#L30
...
pub(crate) mod tests {
    ...
    fn test_calculate_reimbursement() {
        ...
        let juels_per_fee_coin = u128::from_str("6000000000000000000").unwrap(); // 6e18 juels in 1 atom (i.e. 6 pli)
